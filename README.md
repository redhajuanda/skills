...
| **image-decompose** | Generates a copy-paste prompt for AI image generators that decomposes one illustration into an animation-ready background plate plus individual transparent cutouts. |
